...
describe User do
	...
	describe "when email format is not valid" do
		it "should be invalid" do
			addresses = %w[test@example,com test_user_at_example.com 
							test.user@wtf.srs@rly.com test@example+test.com]
	...
	describe "when email format is valid" do
		it "should be valid" do
			addresses = %w[test@example.COM A_JP-test@j.p.org first.last@test.jp
						a+z@ftw.cn]	
